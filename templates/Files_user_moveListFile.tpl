        ...
        <div>
            ...
            <fieldset>
                ...
                <div>
                    ...
                    <label for="dir_{$key}"><span class="fi_image fi_folder">{$dir|safetext}</span></label>
                </div>
                {/foreach}
            </fieldset>
            <div class="z-formbuttons">
				...
				{if $external eq 1}
                <a href="{modurl modname="Files" type="external" func="getFiles" folder=$folder|replace:'/':'|' hook=$hook}">{img modname='core' src='button_cancel.gif' set='icons/small' altml='true' titleml='true' __alt="Cancel" __title="Cancel"}</a>
                {else}
