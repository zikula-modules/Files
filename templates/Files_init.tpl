...
<p class="z-center"><a href="{modurl modname="Files" type="interactiveinstaller" func="form"}">{gt text="Proceed with the installation"}</a></p>
...
<h3>{gt text="Checking if the files folders exist and they are writable"}</h3>
<ul>
	{if not $multisites}
    {if !$file1}
    <li>
...
<div class="z-center">
    {if !$file1 OR !$file2}
    <a href="{modurl modname="Files" type="interactiveinstaller" func="form" file1=$filesRealPath file2=$usersFolder}">{gt text="Define folders again. Remember that you have to create the folders after define them."}</a>
    {/if}
    {if (!$fileWriteable1 OR !$fileWriteable2) AND NOT (!$file1 OR !$file2)}
    <a href="{modurl modname="Files" type="interactiveinstaller" func="form" file1=$filesRealPath file2=$usersFolder}">{gt text="Make the folders writable and try again."}</a>
    {/if}
